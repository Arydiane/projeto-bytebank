...
test('Deve ser possível selecionar uma opcao de transação do elemento select', () => {
    render(<Formulario />)
    const transacao = screen.getByRole('combobox')
    userEvent.selectOptions(transacao, ['Depósito']); 
    expect(
